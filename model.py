...
print(".", end="")
sys.stdout.flush()
train_data = conllreader.ConllDataset("data/train.head.txt", indexer)
print(".", end="")
sys.stdout.flush()
dev_data = conllreader.ConllDataset("data/train.tail.txt", indexer)
print(".", end="")
sys.stdout.flush()
test_data = conllreader.ConllDataset("data/test.txt", indexer)
print(".", end="")
sys.stdout.flush()
indexer.update()
print("finish")
